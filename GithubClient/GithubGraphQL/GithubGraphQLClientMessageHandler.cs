...
namespace GithubClient.GithubGraphQL
{
    ...
    /// </summary>
    public class GithubGraphQLClientMessageHandler : DelegatingHandler
    {
        ...
        public GithubGraphQLClientMessageHandler(ITokenProvider tokenProvider, HttpMessageHandler innerHandler = null)
        {
